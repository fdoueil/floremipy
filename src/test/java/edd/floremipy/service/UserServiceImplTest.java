...
public class UserServiceImplTest {
	...
	public void testAuthenticatePwdIncorrect() {
		// on retourne 'mot de passe incorrect' si login correct, mais pas le
		// bon mot de passe fourni
	...
	public void testGetUser() {
		// On verifie getUser qui nous donne apres authentification le role et
		// le mail d'un user
		String expected = "DIRECTEUR";
		String expectedMail = "directeur@bl.com";
		Long expectedIdCustomer = (long) 10;
		...
		assertEquals(expectedIdCustomer, unUserDTO.getIdCustomer());
	}
