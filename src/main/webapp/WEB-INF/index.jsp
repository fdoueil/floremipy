...
<body>
	...
	<script type="text/javascript">
	 ...
	 var dataSet = {
			{"id":1,"name":"Câdre en boule","category":"Arbres","price":10.99,"stock":10,"description":"","imgsrc":""}
	}; 
	...
	/*	$.ajax({
			...
			success: function(result){
				dataSet = $('#result').html(JSON.parse(result));	
				         }
		           
		        });			*/
	
			
	/*	var dataSet = JSON.parse(CatalogueViewController.allProducts()); /*le JSON de Peggy*/
		var ctr = 0;
		$("#update").click(function() {
			ctr++;
			dataSet.push([ ctr, ctr, ctr, ctr, ctr, ctr, ctr]);
